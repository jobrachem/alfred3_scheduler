...
import os
import sys
sys.path.insert(0, os.path.abspath('../../src/alfred3_scheduler'))


# -- Project information -----------------------------------------------------

project = 'alfred3_scheduler'
copyright = '2022, Johannes Brachem, Christian Treffenstädt'
...
html_theme_options = {
    "repository_url": "https://github.com/jobrachem/alfred3_scheduler",
    "use_repository_button": True,
}

html_title = "alfred3_scheduler"
# html_logo = "_static/alfred_logo_color.png"
...
def linkcode_resolve(domain, info):
    ...
    return f"https://github.com/jobrachem/alfred3_scheduler/blob/main/src/{filename}.py"